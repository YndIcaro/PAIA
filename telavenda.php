...
if(isset($_POST['form'])){
	...
	$sql = "INSERT INTO apartamento(apart_tamanho,apart_localizacao,apart_quarto,apart_cozinha,apart_preco)VALUES ('$apart_tamanho','$apart_localizacao','$apart_quarto','$apart_cozinha','$apart_preco')";
  if ($conn->query($sql)) {
	echo' ';
} else {
...
if(isset($_POST['form2'])){
	...
	$sql = "INSERT INTO casa(casa_tamanho,casa_localizacao,casa_quarto,casa_cozinha,casa_preco)VALUES ('$casa_tamanho','$casa_localizacao','$casa_quarto','$casa_cozinha','$casa_preco')";
  if ($conn->query($sql)) {
	echo' ';
} else {
	echo "Error: " . $sql . "<br>" . $conn->errorInfo();
